...
const Projects = ({ offset, factor = 2 }: { offset: number; factor?: number }) => (
  <div>
    <Divider
      bg="linear-gradient(to right, #1a202c 0%, #4a5568 100%)"
    ...
    <Divider speed={0.1} offset={offset} factor={factor}>
      <UpDown>
        ...
        <Svg icon="upDown" width={8} color="icon_brightest" left="70%" top="20%" />
      ...
      <UpDownWide>
        <Svg icon="arrowUp" hiddenMobile width={16} color="icon_brightest" left="20%" top="90%" />
      ...
      <Svg icon="circle" width={12} color="icon_brightest" left="80%" top="60%" />
      <Svg icon="box" width={6} color="icon_brightest" left="10%" top="10%" />
      <Svg icon="box" width={12} color="icon_brightest" left="29%" top="26%" />
      <Svg icon="hexa" width={16} stroke color="icon_brightest" left="75%" top="30%" />
